        ...
        <div className="container mx-auto">
          <div className="flex flex-col justify-center items-start md:flex-row md:justify-center md:items-center">
            <div className="flex flex-col justify-center items-center md:mt-12">
              ...
              <div className="rounded-xl w-[360px] h-[150px] bg-neutral-200 mt-4 md:w-[600px] md:h-[200px] lg:h-[300px]">
                ...
                <div className="sm:hidden md:flex justify-start md:items-center md:ml-6 mt-8 lg:mt-12">
                  <MailIcon fontSize="medium" sx={{ fill: "gray" }} />
                  <p className="text-base ml-3 text-gray-500 md:text-2xl lg:text-2xl">
                    {email}
                  </p>
                </div>
                <div className="flex justify-start items-center ml-6 mt-8 md:hidden">
              ...
              {roles === "RECRUITER" && <div className="h-[28vh]"></div>}
              {roles == "USER" && (
              ...
              {roles === "USER" && (
                <div className="mt-4">
                  {file ? (
                    <div className="w-[355px] p-4 border border-solid flex items-center border-gray-300 rounded-xl display:none md:w-[600px]">
                      ...
                      <div className="flex flex-col justify-center items-start">
                        <p className="ml-4 md:text-2xl lg:text-lg">
                          {file.name}
                        </p>
                  ...
                  {file && (
                    <p className="md:text-xl lg:text-base">{file.name}</p>
                  )}
                </div>
              )}
              {roles === "USER" && (
